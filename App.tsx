...
const App: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-white text-slate-900 font-sans selection:bg-brand-accent selection:text-white overflow-x-hidden">
      ...
      <header className="relative min-h-screen flex items-center pt-24 overflow-hidden bg-[#0f172a]">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 grid lg:grid-cols-2 gap-12 items-center">
          <div className="space-y-8">
             ...
             <h1 className="text-6xl sm:text-8xl lg:text-[105px] font-black text-white leading-[0.85] tracking-tighter">
            ...
            <div className="flex flex-col sm:flex-row gap-5">
              ...
              <button onClick={() => setIsSchedulerOpen(true)} className="px-10 py-5 bg-white/5 border border-white/10 text-white font-black rounded-2xl hover:bg-white/10 transition-all text-lg flex items-center gap-3">
          ...
          <div className="hidden lg:block relative">
             <div className="p-3 rounded-[3rem] border border-white/10 bg-white/5 backdrop-blur-sm relative">
               ...
               <div className="absolute top-10 -right-10 bg-white/95 backdrop-blur-xl p-8 rounded-3xl shadow-2xl space-y-4 max-w-xs border border-white">
                  ...
                  <p className="text-[10px] text-slate-400 font-bold italic border-t border-slate-100 pt-3">Procurement Ready. High-limit bonding for enterprise sites.</p>
               </div>
             </div>
          </div>
        </div>
            ...
            <div className="lg:col-span-7 grid sm:grid-cols-2 gap-6 lg:gap-8">
               {[
                 ...
                 <button 
                  ...
                  className="p-10 bg-slate-50 rounded-[2.5rem] border border-slate-100 hover:border-brand-accent/20 transition-all group hover:bg-white hover:shadow-2xl text-left"
                 >
      ...
      {/* RISK MITIGATION */}
      <section ref={processSectionRef} className="py-32 bg-[#0f172a] text-white relative overflow-hidden scroll-mt-24">
           ...
           <div className="bg-white/5 border border-white/10 rounded-[3rem] p-12 backdrop-blur-sm relative z-10">
              <div className="space-y-10">
                 <div className="flex justify-between items-center border-b border-white/5 pb-8">
                    <div>
                      <h4 className="text-3xl font-black tracking-tight">Insurance Depth</h4>
                 ...
                 <div className="grid gap-6">
                    {[
                      ...
                      <div key={i} className="flex justify-between items-center py-4 border-b border-white/5 last:border-0 last:pb-0">
                        ...
                        <span className="font-black text-white text-lg tracking-tight">{ins.v}</span>
                      </div>
                    ))}
                 </div>
                 <button onClick={() => setIsSchedulerOpen(true)} className="w-full py-5 bg-white text-slate-900 rounded-2xl font-black uppercase tracking-widest text-[11px] hover:bg-slate-100 transition-colors shadow-xl shadow-white/5">Request Full COI Package</button>
              </div>
           </div>
        </div>
      </section>
            ...
            <div className="animate-in fade-in slide-in-from-bottom-8 duration-700 text-center">
               ...
               <div className="grid grid-cols-2 lg:grid-cols-4 gap-6 max-w-5xl mx-auto">
                 {[
                   ...
                   <button key={item.id} onClick={() => selectIndustry(item.id as IndustryType)} className="group flex flex-col items-center text-center p-10 bg-white border-2 border-slate-100 rounded-[2.5rem] hover:border-brand-accent hover:shadow-2xl hover:shadow-brand-accent/10 transition-all">
            ...
            <div className="animate-in fade-in slide-in-from-right-8 duration-700">
               ...
               <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto">
                 <button onClick={() => selectObjective('recurring')} className="group p-12 bg-white border-2 border-slate-100 rounded-[3rem] text-left hover:border-brand-accent hover:shadow-2xl transition-all">
                   ...
                   <p className="text-slate-500 font-medium leading-relaxed mb-8 text-lg">Daily managed precision maintenance delivered as a fixed, all-inclusive monthly budget for long-term care.</p>
                 ...
                 <button onClick={() => selectObjective('onetime')} className="group p-12 bg-[#0f172a] text-white border-2 border-slate-800 rounded-[3rem] text-left hover:border-brand-accent hover:shadow-2xl transition-all">
                   ...
                   <h4 className="text-3xl font-black mb-4">RFP / Specific Project</h4>
                   <p className="text-slate-400 font-medium leading-relaxed mb-8 text-lg">One-time deep sanitation, project scope estimation, or specific RFP invitation for portfolio restoration.</p>
                    ...
                    {!isUnlocked ? (
                      <div className="bg-[#0f172a] text-white p-12 rounded-[3rem] shadow-2xl text-center space-y-8">
                        ...
                        <div>
                          ...
                          <p className="text-slate-400 font-medium">We've generated a multi-layer labor allocation based on your specific sector requirements.</p>
                        </div>
                        <button onClick={() => setIsUnlocked(true)} className="w-full bg-brand-accent hover:bg-brand-accentLight py-5 rounded-2xl font-black uppercase tracking-widest text-[10px] shadow-xl shadow-brand-accent/20 transition-all">Unlock Target Quote</button>
                      </div>
                    ) : (
      ...
      <footer className="bg-[#0f172a] text-white py-24 border-t border-white/5">
        <div className="max-w-7xl mx-auto px-6 grid md:grid-cols-2 gap-24">
          <div className="space-y-8">
            ...
            <p className="text-slate-400 text-lg font-medium max-w-sm">Strategic maintenance for multi-site portfolios across NY, FL, NJ, & CT. Managed labor, predictable outcomes, asset protection.</p>
          </div>
